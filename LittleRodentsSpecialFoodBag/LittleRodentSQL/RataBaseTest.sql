DROP DATABASE IF EXISTS littleRodentTest;
CREATE DATABASE littleRodentTest;

USE littleRodentTest;
...
CREATE TABLE orders(
    ...
    FOREIGN KEY (foodPlaceId) REFERENCES foodPlaces(id) ON DELETE CASCADE
    );
